          ...
          <div className="p-4 flex items-center justify-between gap-4">
            <div className="flex-1 min-w-0">
              ...
              <div className="flex gap-3 mt-1">
                <span
                  className={`text-xs px-2 py-0.5 rounded font-mono ${target.ac_bonus > 0 ? 'bg-amber-900/40 text-amber-400 border border-amber-800/50' : 'bg-slate-700 text-slate-400'}`}
                >
                  AC +{target.ac_bonus}
                </span>
                <span
                  className={`text-xs px-2 py-0.5 rounded font-mono ${target.reflex_bonus > 0 ? 'bg-emerald-900/40 text-emerald-400 border border-emerald-800/50' : 'bg-slate-700 text-slate-400'}`}
                >
