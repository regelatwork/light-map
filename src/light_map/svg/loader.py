...
from .utils import get_element_label, get_viewport_matrix
from .geometry import collect_grid_coordinates, analyze_spacing_and_origin
...
from .blockers import get_visibility_blockers as extract_blockers
from ..visibility_types import VisibilityBlocker
