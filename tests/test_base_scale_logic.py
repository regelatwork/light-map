...
def test_base_scale_updates_on_load(app, tmp_path):
    ...
    with open(map_path, "w") as f:
        f.write('<svg width="1000" height="1000"><rect x="0" y="0" width="100" height="100" /></svg>')
    
    # 1. Calibrate grid: 100 SVG units = 1 inch. At 100 PPI, base_scale should be 1.0.
    app.map_config.save_map_grid_config(
        map_path, grid_spacing_svg=100.0, grid_origin_svg_x=0.0, grid_origin_svg_y=0.0,
        physical_unit_inches=1.0, scale_factor_1to1=1.0
    )
