...
def test_aruco_detector_resolves_duplicates(
    ...
    corners2 = np.array([[[100, 100], [120, 100], [120, 120], [100, 120]]], dtype=np.float32)
...
def test_aruco_detector_multiple_ids_with_duplicates(
    mock_map_system
):
...
def test_aruco_detector_orders_by_area(
    ...
    c1_large = np.array([[[0, 0], [20, 0], [20, 20], [0, 20]]], dtype=np.float32) # area 400
    c1_small = np.array([[[50, 50], [60, 50], [60, 60], [50, 60]]], dtype=np.float32) # area 100
    c2_med = np.array([[[100, 100], [114.14, 100], [114.14, 114.14], [100, 114.14]]], dtype=np.float32) # area approx 200
