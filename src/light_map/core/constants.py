...
DEFAULT_ARUCO_MASK_PADDING = 10
DEFAULT_ARUCO_MASK_COLOR = (64, 64, 64, 255)
DEFAULT_TOKEN_HEIGHT_MM = 50.0
DEFAULT_PROJECTOR_PPI = 96.0
DEFAULT_POINTER_EXTENSION_INCHES = 2.0
DEFAULT_POINTER_OFFSET_MM = 50.8
DEFAULT_ARUCO_MASK_INTENSITY = 64
DEFAULT_ARUCO_MASK_PERSISTENCE_S = 2.0
