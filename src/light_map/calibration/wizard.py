...
class StereoCalibrationWizard:
    ...
    def _discover_cameras(self, r_stereo: np.ndarray, t_stereo: np.ndarray) -> Tuple[str, str]:
        ...
        if t_stereo[0] > 0:
            ...
            return "camera_right", "camera_left"
    ...
    def _compute_roi(self, r_left, t_left, r_right, t_right, 
                      k_left, k_right, dist_left, dist_right, ppi):
        """
        Computes the sensor ROIs with 200mm parallax margin.
        """
