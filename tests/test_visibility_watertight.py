...
def test_watertight_blocking():
    ...
    blockers = [
        VisibilityBlocker(segments=[(0, 100), (300, 100)], type=VisibilityType.WALL, layer_name="walls")
    ]
...
def test_corner_peeking():
    ...
    blockers = [
        VisibilityBlocker(segments=[(0, 100), (100, 100)], type=VisibilityType.WALL, layer_name="walls"),
        VisibilityBlocker(segments=[(100, 100), (100, 200)], type=VisibilityType.WALL, layer_name="walls")
    ]
    mask_w, mask_h = 256, 256
    engine.update_blockers(blockers, mask_width=mask_w, mask_height=mask_h)
