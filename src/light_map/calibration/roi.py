...
def calculate_roi(
    ...
    # Project Z=0 points
    pts_l_0 = cv2.projectPoints(
        grid_corners_world, camera_matrix_l, distortion_coefficients_l, (None, None)
    )
    pts_r_0 = cv2.projectPoints(
        grid_corners_world, camera_matrix_r, distortion_coefficients_r, (None, None)
    )
    ...
    pts_l_200 = cv2.projectPoints(
        grid_corners_200, camera_matrix_l, distortion_coefficients_l, (None, None)
    )
    pts_r_200 = cv2.projectPoints(
        grid_corners_200, camera_matrix_r, distortion_coefficients_r, (None, None)
    )
    ...
    roi_l = [min_x_l - margin_l, min_y_l - margin_l, max_x_l + margin_l, max_y_l + margin_l]

    roi_r = [min_x_r - margin_r, min_y_r - margin_r, max_x_r + margin_r, max_y_r + margin_r]
