                ...
                {editingProfile?.name === name ? (
                  ...
                  <>
                    ...
                    <div className="text-xs text-gray-500 space-y-1">
                      <p>
                        Size: <span className="font-semibold text-gray-700">{profile.size}</span>
                      </p>
                      <p>
                        Height:{' '}
                        <span className="font-semibold text-gray-700">{profile.height_mm}mm</span>
                      </p>
                    </div>
                  </>
                )}
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-4 py-2 text-right text-[10px] font-bold text-gray-500 uppercase">
                  Actions
                </th>
              </tr>
            </thead>
              ...
              {Object.keys(config.aruco_defaults || {}).length === 0 && (
                <tr>
                  <td colSpan={5} className="px-4 py-8 text-center text-sm text-gray-400 italic">
                    No ArUco tokens registered yet. Register an ID above or configure a token from
                    the Schematic view.
                  </td>
                </tr>
              )}
