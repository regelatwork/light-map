...
4.  **Dark Theme & Visibility**: Use a dark palette to reduce light pollution; automatically inverts dark SVG paths to white for visibility.
...
3.  **Calculation**: `PPI = Distance_Projector_Px / (100mm / 25.4)`.
4.  **Verification**: A green 1-inch grid is projected. User confirms with **Victory** or retries with **Open Palm**.
