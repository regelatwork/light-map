...
from light_map.core.common_types import DetectionResult, Token, ResultType
from light_map.core.constants import DEFAULT_PROJECTOR_PPI
...
class StereoTriangulator:
    ...
    def process_left_result(self, left_res: DetectionResult) -> StereoTriangulationResult:
        ...
        """
        best_right: Optional[DetectionResult] = None
        min_diff = float('inf')
        ...
        pts_L_undist_fallback = self._undistort_point(uL_fallback, vL_fallback, self.K_L, self.dist_L)
        
        return self._handle_fallback(left_res, pts_L_undist_fallback)

    def _handle_fallback(self, left_res: DetectionResult, pts_L_undist: np.ndarray) -> StereoTriangulationResult:
        """
