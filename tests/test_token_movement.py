...
from light_map.common_types import Token, AppConfig, DetectionResult, ResultType, ViewportState
...
def test_token_movement_propagation():
    ...
    world_res_1 = DetectionResult(
        timestamp=1000, type=ResultType.ARUCO, 
    ...
    world_res_2 = DetectionResult(
        timestamp=1010, type=ResultType.ARUCO, 
    ...
    world_res_3 = DetectionResult(
        timestamp=1020, type=ResultType.ARUCO, 
