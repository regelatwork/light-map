    ...
    with patch("light_map.calibration.wizard.load_intrinsics") as mock_load:
        ...
        wizard.marker_detector.detect = MagicMock(
            return_value=[
                 ...
                 (42, np.array([[14, 14], [15, 15]])),
                 (43, np.array([[16, 16], [17, 17]])),
                 (44, np.array([[18, 18], [19, 19]])),
                 (45, np.array([[20, 20], [21, 21]])),
                 (46, np.array([[22, 22], [23, 23]])),
                 (47, np.array([[24, 24], [25, 25]])),
                 (48, np.array([[26, 26], [27, 27]])),
                 (49, np.array([[28, 28], [29, 29]])),
