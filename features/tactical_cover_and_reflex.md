...
1. **Trace Rays:** For each Target pixel, check if it is "visible" from **any** Attacker pixel using the stamped mask.
1. **Determine Status:**
...
1. **Aggregate Grades:** The final cover grade is determined by the percentage of obscured vs. soft-cover lines. Harder cover always takes precedence for a given ray.
